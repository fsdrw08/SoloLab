#!/bin/vbash
mkdir -p /home/vagrant/samba/{data,share}
...
set container name samba image crazymax/samba
...
set container name samba volume 'samba_config' source '/home/vagrant/samba/data'
set container name samba volume 'samba_config' destination '/data'
set container name samba volume 'samba_share' source '/home/vagrant/samba/share'
set container name samba volume 'samba_share' destination '/samba/share'
