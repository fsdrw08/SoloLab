...
# https://github.com/rgl/alpine-vagrant/blob/master/provision.sh
...
apk add sudo
adduser vagrant --disabled-password
echo 'vagrant:vagrant' | chpasswd
adduser vagrant wheel
...
wget -qO /home/vagrant/.ssh/authorized_keys https://gitee.com/mirrors/vagrant/raw/main/keys/vagrant.pub
