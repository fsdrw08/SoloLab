...
# Install cloud-init
apt-get install -t equuleus -y --force-yes cloud-init cloud-utils ifupdown jq yq nfs-ganesha nfs-ganesha-vfs
...
# origin file: https://github.com/vyos/vyos-cloud-init/blob/equuleus/config/cloud.cfg.d/10_vyos.cfg
