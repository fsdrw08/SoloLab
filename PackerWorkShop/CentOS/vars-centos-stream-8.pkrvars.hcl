...
iso_url="C:/Users/Public/Downloads/ISO/CentOS-Stream-8-latest-x86_64-boot.iso"
iso_checksum="74f1779da2b7ea0e6f01de16a1dd28b11cf9d6b4727365a4730e666c44527588"
iso_checksum_type="sha256"
vm_name="packer-centos-stream-8-g2"
...
output_directory="C:/ProgramData/Microsoft/Windows/Virtual Hard Disks/output-centos-stream-8-base"
output_vagrant="../vbox/packer-centos-stream-8-hv-g2.box"
vlan_id=""
vagrantfile_template="./vagrant-centos-stream-8.rb"
...
boot_command=[
  "c  setparams 'kickstart' <enter> linuxefi /images/pxeboot/vmlinuz inst.stage2=hd:LABEL=CentOS-Stream-8-BaseOS-x86_64 inst.ks=hd:LABEL=cidata:/ks-centos-stream-8.cfg<enter> initrdefi /images/pxeboot/initrd.img<enter> boot<enter><wait30>"
]
