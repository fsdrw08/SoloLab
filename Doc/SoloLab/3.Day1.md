...
### 6. Config PKI intermediate CA in Vault
...
### 8. Config LDAP login and sync LDAP user/group to Vault
...
### 9. Config Vault as OIDC provider
...
### 11. Config Consul secret backend / gossip key secret for Consul in Vault
...
### 12. Deploy Consul server to Day1 VM
...
### 13. Config ACL policy in Consul
...
### 14. Deploy Traefik proxy in Day1 VM
...
### 15. Deploy consul client to Day0 VM
...
### 16. Deploy consul client to VyOS VM
...
### 17. Deploy Nomad server to Day1 VM
...
### 18. Config Nomad OIDC login and add management token
...
### 19. Config Vault JWT auth for nomad
...
### 20. Config Consul JWT auth for nomad
...
### 21. Deploy Nomad client to Day1 VM
...
### 22. Deploy nomad nfs csi controller
...
### 28. Deploy Prometheus in Day1 VM
