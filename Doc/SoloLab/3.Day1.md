...
Pre-request:
1. External DNS record for traefik.day1.sololab (in VyOS `Seed DNS record to PowerDNS`)
2. External L4 loadbalancer for traefik.day1.sololab (in VyOS `Config haproxy in VyOS`) 
3. Internal DNS record for traefik.day1.sololab (in Day0 `Seed DNS record to etcd`)
4. Traefik container image to zot.day0.sololab (in Day1 `Sync Day1 related container images to zot`)
...
4. Consul container image to zot.day0.sololab (in Day1 `Sync Day1 related container images to zot`)
...
Pre-request:
1. External DNS record for grafana.day1.sololab (in VyOS `Seed DNS record to PowerDNS`)
2. External L4 loadbalancer for grafana.day1.sololab (in VyOS `Config haproxy in VyOS`) 
3. Internal DNS record for grafana.day1.sololab (in Day0 `Seed DNS record to etcd`)
4. Grafana container image to zot.day0.sololab (in Day1 `Sync Day1 related container images to zot`)
...
Pre-request:
1. External DNS record for prometheus.day1.sololab (in VyOS `Seed DNS record to PowerDNS`)
2. External L4 loadbalancer for prometheus.day1.sololab (in VyOS `Config haproxy in VyOS`) 
3. Internal DNS record for prometheus.day1.sololab (in Day0 `Seed DNS record to etcd`)
4. Prometheus container image to zot.day0.sololab (in Day1 `Sync Day1 related container images to zot`)
...
Pre-request:
1. External DNS record for nomad.day1.sololab (in VyOS `Seed DNS record to PowerDNS`)
2. External L4 loadbalancer for nomad.day1.sololab (in VyOS `Config haproxy in VyOS`) 
3. Internal DNS record for nomad.day1.sololab (in Day0 `Seed DNS record to etcd`)
4. Nomad container image to zot.day0.sololab (in Day1 `Sync Day1 related container images to zot`)
