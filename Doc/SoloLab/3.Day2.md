...
Check pre-requirements: [TerraformWorkShop/Quadlet/grafana/](../../TerraformWorkShop/Quadlet/grafana/README.md#Requirements)
```powershell
$credential = Get-Credential -Message "credential to login vault" -UserName "000"
$env:VAULT_ADDR = "https://vault.day1.sololab"
vault login -no-print -method=ldap username=$($credential.UserName) password=$($credential.GetNetworkCredential().Password)
...
Check pre-requirements: [TerraformWorkShop/Consul/Auth/JWT](../../TerraformWorkShop/Consul/Auth/JWT/README.md)
```powershell
$credential = Get-Credential -Message "credential to login vault" -UserName "000"
$env:VAULT_ADDR = "https://vault.day1.sololab"
vault login -no-print -method=ldap username=$($credential.UserName) password=$($credential.GetNetworkCredential().Password)
