...
3. Internal DNS record for traefik.day2.sololab (in Day0 `Seed DNS record to etcd`)
4. Traefik container image to zot.day0.sololab (in Day2 `Sync Day2 related container images to zot`)
...
Pre-request:
1. External DNS record for consul-client.day0.sololab (in VyOS `Seed DNS record to PowerDNS`)
2. External L4 loadbalancer for consul-client.day0.sololab (in VyOS `Config haproxy in VyOS`) 
3. Internal DNS record for consul-client.day0.sololab (in Day0 `Seed DNS record to etcd`)
4. Consul container image to zot.day0.sololab (in Day2 `Sync Day2 related container images to zot`)
...
3. Internal DNS record for grafana.day2.sololab (in Day0 `Seed DNS record to etcd`)
4. Grafana container image to zot.day0.sololab (in Day2 `Sync Day2 related container images to zot`)
5. Grafana related LDAP group entity in lldap.day0.sololab (in Day0 `Config LDAP auth backend (login) and sync LDAP user/group to Vault`)
...
3. Internal DNS record for prometheus.day2.sololab (in Day0 `Seed DNS record to etcd`)
4. Prometheus container image to zot.day0.sololab (in Day2 `Sync Day2 related container images to zot`)
...
3. Internal DNS record for nomad.day2.sololab (in Day0 `Seed DNS record to etcd`)
4. Nomad container image to zot.day0.sololab (in Day2 `Sync Day2 related container images to zot`)
5. Nomad related LDAP group entity in lldap.day0.sololab (in Day0 `Seed LDAP data in LLDAP`)
6. LDAP user and group had already sync to Vault (in Day0 `Config LDAP auth backend (login) and sync LDAP user/group to Vault`)
...
Pre-request:
1. Vault ACL policy had already config (e.g. secret path permissions in Day0 `Update ACL policy in Vault`)
