...
$To=Join-Path -Path $env:USERPROFILE -ChildPath ".ssh"
...
Set-Location -Path (Join-Path -Path $repoDir -ChildPath $childPath)
$proxy="127.0.0.1:7890"; $env:HTTP_PROXY=$proxy; $env:HTTPS_PROXY=$proxy; $env:NO_PROXY="sololab"
.\Sync-TrivyDB.ps1 -SyncProfile "VyOS-Trivy.jsonc" # -Upload $false
# .\Sync-TrivyDB.ps1 -SyncProfile "VyOS-Trivy.jsonc" -LocalStore "D:/Users/Public/Downloads/containers/trivy" -Upload $false
```
