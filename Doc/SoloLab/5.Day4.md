...
Check pre-requirements: [TerraformWorkShop/Nomad/Jobs/gitea/](../../TerraformWorkShop/Nomad/Jobs/gitea/)
```powershell
$repoDir=git rev-parse --show-toplevel
...
Check pre-requirements: [TerraformWorkShop/Nomad/Jobs/otf/](../../TerraformWorkShop/Nomad/Jobs/otf/)
#### Network Pre-request:
