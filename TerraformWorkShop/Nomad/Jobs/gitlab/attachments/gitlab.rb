...
gitlab_rails['db_username'] = '{{with secret "kvv2_pgsql/data/gitea"}}{{.Data.data.user_name}}{{end}}'
gitlab_rails['db_password'] = '{{with secret "kvv2_pgsql/data/gitea"}}{{.Data.data.user_password}}{{end}}'
...
registry['database'] = {
  ...
  'password' => '{{with secret "kvv2_pgsql/data/gitea"}}{{.Data.data.user_password}}{{end}}',
