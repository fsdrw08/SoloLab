    ...
    task "otf-db" {
      ...
      service {
        ...
        meta {
          ...
          dbName   = "otf"
          dbConfig = "host=${NOMAD_TASK_NAME}-${NOMAD_ALLOC_ID} dbname=otf auth_user=pgbouncer"
          ...
          # https://prometheus-postgres-exporter.service.consul/probe?auth_module=postgres_exporter&target=postgresql-day3.service.consul%3A5432%2Fotf
          ...
          prom_target_metrics_path_param_target      = "pgbouncer.service.consul:6432/otf"
        }
      }
