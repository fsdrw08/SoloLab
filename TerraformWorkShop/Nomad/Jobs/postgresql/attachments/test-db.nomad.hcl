    ...
    task "test-db" {
      ...
      service {
        ...
        meta {
          ...
          # https://prometheus-postgres-exporter.service.consul/probe?auth_module=postgres_exporter&target=postgresql-day3.service.consul%3A5432%2Ftest
          ...
          prom_target_metrics_path_param_target      = "pgbouncer.service.consul:6432/test"
        }
      }
      ...
      template {
        ...
        host  all           {{with secret "kvv2_others/data/app-test"}}{{.Data.data.pgsql_user_name}}{{end}}       all           scram-sha-256
        EOH
      ...
      template {
        ...
        POSTGRESQL_USER={{with secret "kvv2_others/data/app-test"}}{{.Data.data.pgsql_user_name}}{{end}}
        POSTGRESQL_PASSWORD={{with secret "kvv2_others/data/app-test"}}{{.Data.data.pgsql_user_password}}{{end}}
        POSTGRESQL_ADMIN_PASSWORD={{with secret "kvv2_others/data/app-test"}}{{.Data.data.pgsql_admin_password}}{{end}}
        EOH
