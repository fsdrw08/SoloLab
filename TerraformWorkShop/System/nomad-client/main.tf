...
module "nomad" {
  ...
  install = [
    ...
    {
      zip_file_source = "https://dufs.day1.sololab/public/binaries/nomad-driver-podman_0.6.5_linux_amd64.zip"
      zip_file_path   = "/var/home/core/nomad-driver-podman_0.6.5_linux_amd64.zip"
