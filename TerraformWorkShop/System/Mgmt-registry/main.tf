...
module "registry" {
  ...
  install = {
    ...
    tar_file_source = "http://files.day1.sololab/releases/registry_2.8.3_linux_amd64.tar.gz"
  ...
  config = {
    main = {
      ...
      content = templatefile("${path.root}/registry/config.yml", {
        ...
        REGISTRY_HTTP_HOST            = "https://registry.day1.sololab"
        ...
        REGISTRY_HTTP_HEADERS_Access-Control-Allow-Origin      = "[https://registry-ui.day1.sololab]"
