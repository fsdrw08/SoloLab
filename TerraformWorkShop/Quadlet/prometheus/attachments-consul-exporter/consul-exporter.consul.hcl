services {
  ...
  tags = [
    ...
    # "traefik.http.routers.prometheus-consul-exporter-redirect.rule=Host(`prometheus-consul-exporter.day2.sololab`)",
    ...
    # "traefik.http.routers.prometheus-consul-exporter.rule=Host(`prometheus-consul-exporter.day2.sololab`)",
    # "traefik.http.routers.prometheus-consul-exporter.tls=true",
  ]
  meta = {
    prom_blackbox_scheme            = "https"
    prom_blackbox_address           = "prometheus-consul-exporter.day2.sololab"
    prom_blackbox_health_check_path = "metrics"

    prom_target_scheme       = "https"
    prom_target_address      = "prometheus-consul-exporter.day2.sololab"
