services {
  ...
  id   = "prometheus-podman-exporter-day2"
  port = 443
  ...
  meta = {
    ...
    prom_blackbox_address           = "day2.prometheus-podman-exporter.service.consul"
    prom_blackbox_health_check_path = "metrics"

    prom_target_scheme       = "https"
    prom_target_address      = "day2.prometheus-podman-exporter.service.consul"
