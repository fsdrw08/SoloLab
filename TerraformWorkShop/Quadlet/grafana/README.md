...
```powershell
scp -r "C:\Users\Public\Downloads\grafana\grafana-lokiexplore-app" Day2-FCOS:/var/home/podmgr/.local/share/containers/storage/volumes/grafana-pvc/_data/plugins/
```
