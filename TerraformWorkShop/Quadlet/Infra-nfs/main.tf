data "terraform_remote_state" "root_ca" {
  count   = var.podman_kube.helm.tls == null ? 0 : var.podman_kube.helm.tls.tfstate == null ? 0 : 1
  backend = var.podman_kube.helm.tls.tfstate.backend.type
  config  = var.podman_kube.helm.tls.tfstate.backend.config
}

locals {
  cert = var.podman_kube.helm.tls == null ? 0 : var.podman_kube.helm.tls.tfstate == null ? null : [
