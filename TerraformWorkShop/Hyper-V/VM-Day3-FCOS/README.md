...
sudo bash -c "nomad_driver_podman_download_url=http://dufs.day1.sololab/public/binaries/nomad-driver-podman_0.6.5_linux_amd64.zip custom_bin_dir=/opt/bin /opt/bin/nomad_driver_podman_install.sh"
sudo bash -c "nomad_download_url=http://dufs.day1.sololab/public/binaries/nomad_2.0.4_linux_amd64.zip custom_bin_dir=/opt/bin /opt/bin/nomad_install.sh"
```