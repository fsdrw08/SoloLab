...
butane = {
  ...
  vars = {
    global = {
      ...
      "domain_router"      = "day0.sololab."
      "domain_router_dns"  = "192.168.255.1"
      ...
      "packages"                 = "cockpit-system cockpit-ostree cockpit-podman cockpit-networkmanager cockpit-bridge xfsdump"
